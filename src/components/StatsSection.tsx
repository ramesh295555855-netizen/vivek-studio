...
export default function StatsSection() {
  ...
  return (
    <section className="py-12 bg-black/40 backdrop-blur-3xl border-y border-white/5">
      <div className="max-w-6xl mx-auto px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {stats.map((stat, i) => (
            ...
            >
              <div className="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-white/5 border border-white/10 transition-transform group-hover:scale-110">
